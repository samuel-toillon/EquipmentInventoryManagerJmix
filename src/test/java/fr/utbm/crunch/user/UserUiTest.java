package fr.utbm.crunch.user;

import fr.utbm.crunch.entity.User;
import fr.utbm.crunch.screen.user.UserBrowse;
import fr.utbm.crunch.screen.user.UserEdit;
import fr.utbm.crunch.test_support.UiIntegrationTest;
