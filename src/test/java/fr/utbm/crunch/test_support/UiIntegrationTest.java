package fr.utbm.crunch.test_support;

import fr.utbm.crunch.InventoryApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "fr.utbm.crunch.screen")
@ContextConfiguration(classes = {InventoryApplication.class, UiTestAssistConfiguration.class})
